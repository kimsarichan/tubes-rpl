      ...
      <section class="wrapper">
          <div class="col-lg-12">  
            ...
            <div class="col-lg-12">    
                      ...
                      <div class="col-sm-10">
                          <input type="text" name="nip" value="<?php echo $data['NIP'] ?>" class="form-control" disabled>
                      </div>
                      <br><br><br>
                      ...
                      <div class="col-sm-10">
                          <input type="text" name="jabatan" value="<?php echo $data['jabatan'] ?>" class="form-control" disabled>
                      </div>
                       <br><br><br>
                      <label class="col-sm-2 col-sm-2 control-label">Masa Kerja</label>
                      <div class="col-sm-10">
                          <input type="text"placeholder="" name="masaJabatan" class="form-control" disabled>
                      </div>
                       <br><br><br>
