...
$update=mysql_query("update perawat set nama='$nama', tanggalLahir='$tanggallahir', alamat='$alamat', jeniskelamin='$jk', jabatan='$jabatan', masaJabatan='$masajabatan', noTelepon='$telepon', email='$email' where nip='$nip'");
if($update){
